  ...
  return (
    <div className="w-full max-w-[1344px] mx-auto mt-[48px] px-[16px]">
      ...
      <div className="flex flex-col lg:flex-row gap-[12px] mt-[48px] justify-center">
        {/* Men's Section */}
        <div className="w-full sm:w-[440px] lg:w-[440px] h-[540px] bg-[url('/images/image9.svg')] bg-cover bg-center relative">
        ...
        {/* Women's Section */}
        <div className="w-full sm:w-[440px] lg:w-[440px] h-[540px] bg-[url('/images/image10.svg')] bg-cover bg-center relative">
        ...
        {/* Kids' Section */}
        <div className="w-full sm:w-[440px] lg:w-[440px] h-[540px] bg-[url('/images/image11.svg')] bg-cover bg-center relative">
